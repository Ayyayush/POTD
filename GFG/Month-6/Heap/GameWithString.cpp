...
//////////////////////////////////////////////////////////////////////////////////////////////////
// Approach 1: Count frequency of each character, use greedy strategy
//  to always reduce the character with highest frequency (to minimize square sum).
...
int main() {
    // Call whichever version you want to test
    // brute();
    // better();
    // optimal();
    return 0;
